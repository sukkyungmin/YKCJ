...
{
    /// <summary>
    /// F_02_01_SavePopup.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class F_02_01_SavePopup : Window
    {

        private F_02_01_ViewModel Viewmodel = null;
        //private F_01_01_RichTextBox Richtextboxcons = null;

        private double orginalWidth, originalHeight;
        private ScaleTransform scale = new ScaleTransform();

        public F_02_01_SavePopup(F_02_01_ViewModel model)
        {
            InitializeComponent();
            ...
            _savebutton.Content = (!Viewmodel.Modifymode) ? "SAVE" : "MODIFY";
        ...
        private void Change_ReportText()
        {
            //_C1rtbz.Html = 
        }
